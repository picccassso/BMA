...
public final class ActivitySetupBinding implements ViewBinding {
  ...
  @NonNull
  public final FragmentContainerView setupContainer;

  private ActivitySetupBinding(@NonNull ConstraintLayout rootView,
      @NonNull FragmentContainerView setupContainer) {
  ...
  public static ActivitySetupBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.setup_container;
      FragmentContainerView setupContainer = ViewBindings.findChildViewById(rootView, id);
      if (setupContainer == null) {
        break missingId;
      }

      return new ActivitySetupBinding((ConstraintLayout) rootView, setupContainer);
    }
